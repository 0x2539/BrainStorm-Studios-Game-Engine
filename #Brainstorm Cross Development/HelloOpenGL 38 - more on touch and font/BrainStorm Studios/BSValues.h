...
#ifndef HelloOpenGL_Values_h
#define HelloOpenGL_Values_h
...
/*
 template <class T>
 double SDL_GetTicks() {
 double timp = CACurrentMediaTime();
 //long timp
...
extern CGPoint lastMovementPosition;
extern CGPoint startPoint, endPoint;


extern void *obj;

extern GLubyte iData[4];
...
{
	float x, y, w, h;
	GLuint textureUp, textureDown, vao, vbo, ibo;
	BSTexturedVertex2D data[4];
...
{
	char theCharArray1D[100], theCharArray2D[100][100], theCharArray2DAttributes[100][100];
};
...
extern BSTheFontLetters *letters[100];
...
extern glm::mat4 BSModelViewMatrix, BSProjectionMatrix;
...
extern bool DarkLevels, levelHasScript;
...
extern bool settingsFromFirstOrGame;

extern float HeroInitialX, HeroInitialY;


///The sound buffers
/*extern ALuint SourceSoundBeginningGame, SourceSoundJump, SourceSoundDies, SourceSoundMusic, SourceSoundCoin;
 extern ALuint BufferSoundBeginningGame, BufferSoundJump, BufferSoundDies, BufferSoundMusic, BufferSoundCoin;
 */

extern int addCircleOrSquare;///1 = square, -1 = circle, 2 = square texture, -2 = round texture
...
extern bool canClick, aDatClick, isSpaceDown;

extern float speedWalk, speedWalkFast, speedRun, speedJumpUp, speedJumpToSide, speedGoDown, speedJumpUpOnWall,
speedWalkInAir, speedWalkInAirFast, speedJumpToTheSameSide, timeToStayInAirWhenJumpsOnTheSameWall, timeToStayOnWall, originalMoveSpeed;

extern float gameBoundLeft, gameBoundRight, gameBoundDown, gameBoundUp;

extern BSBody *originalParticle, *originalTransparentMenu, *originalCoin, *originalFan, *originalBody, *originalDarkLevel, *originalDarkMenu,
*originalRainDrop, *originalWormHole, *originalDustBody, *originalFanParticleX, *originalFanParticleY;
...
extern int numberOfSquaresForPath;
