...
double BSActionStuff::SDL_GetTicks()
{
			...
			for(int i = currentParticleNr ; i < currentParticleNr + 50; i++)
			{
				...
				if(aCreat == false)
				{
					...
					for(int i = 0 ; i < 2 ; i++)
					{
						...
						newParticle->theBodyOfParticle = objectObstacles->createBodies(b2_dynamicBody,
		...
		if(canAddObstacles)
		{
			...
			if(addCircleOrSquare == 1)
			{
				...
				if(dejaExistaSquare == false)
				{
					...
					objectObstacles->addDinamicSquare(createObstacleX, createObstacleY, widthOfObstacle, heightOfObstacle,
				...
				if(addCircleOrSquare == -1)
				{
					...
					if(dejaExistaRound == false)
					{
						...
						objectObstacles->addDinamicRound(createObstacleX, createObstacleY, theRenderedObstacleCircle->radius,
					...
					if(addCircleOrSquare == 2)
					{
						...
						if(dejaExistaSquareTexture == false)
						{
							...
							objectObstacles->addOnlyTexture(1, createObstacleX, createObstacleY, widthOfObstacle, heightOfObstacle, "texture.png");
						...
						if(addCircleOrSquare == -2)
						{
							...
							if(dejaExistaRoundTexture == false)
							{
								...
								objectObstacles->addOnlyTexture(-1, createObstacleX, createObstacleY, widthOfObstacle, widthOfObstacle, "texture.png");
	...
	if(MouseRight && canClickRight)
	{
		...
		if(canAddObstacles)
		{
            ...
            if(addCircleOrSquare == 1)
            {
                ...
                if(dejaExistaSquare)
                {
                    objectObstacles->deleteBodySquare(CorpulCareVreauSaStergSquare);
                ...
                if(addCircleOrSquare == -1)
                {
                    ...
                    if(dejaExistaRound)
                    {
                        objectObstacles->deleteBodyRound(CorpulCareVreauSaStergRound);
