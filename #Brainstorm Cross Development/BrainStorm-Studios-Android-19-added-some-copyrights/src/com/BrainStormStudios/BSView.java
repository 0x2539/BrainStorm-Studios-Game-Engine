...
class BSView extends GLSurfaceView
{
    ...
    public BSView(Context context, boolean translucent, int depth, int stencil)
    {
        super(context);
    ...
    private void init(Context context, boolean translucent, int depth, int stencil)
    {
        ...
        //if (translucent)
        {
            this.getHolder().setFormat(PixelFormat.RGBA_8888);//.TRANSLUCENT);
        }
    ...
    private static class Renderer implements GLSurfaceView.Renderer
    {
        ...
        {
            BSMainLib.step(BSMainLib.xTouch, BSMainLib.yTouch);
        }
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height)
        {
            ...
            try
            {
                appInfo = packMgmr.getApplicationInfo("com.BrainStormStudios", 0);
            }
            catch (NameNotFoundException e)
            {
                e.printStackTrace();
                Log.w(TAG, "Unable to locate assets, aborting...");
                throw new RuntimeException("Unable to locate assets, aborting...");
            }
            apkFilePath = appInfo.sourceDir;
            Log.w(TAG, apkFilePath);
            BSMainLib.init(width, height, apkFilePath);
        }
