...
/*
    ...
    ////ATENTION - I just swapped the vbo with the vao in the header of the methods, because in BSTexture.cpp the objects will pass the vao as a variable to the renderer.
    ////And now, instead of passing the vao, they are actually passing the vbo
