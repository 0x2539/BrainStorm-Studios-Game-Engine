...
class BSTexturedPolygonProgram2D : public BSShaderProgram
{
    ...
    void loadShaderAttributesLocation(GLuint &theAttribute, std::string theShaderAttributeText);
    void loadShaderUniformsLocation(GLuint &theUniform, std::string theShaderUniformText);
};
