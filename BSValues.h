...
template <class T>
std::string BS_ToString(const T &value_to_convert)
{
...
template <class T>
T BS_AngleToRadians(T angle_in_degree)
{
	T pi = 3.14159265;
	return (T)pi * angle_in_degree / 180;
}

extern std::unordered_map<std::string, GLuint> BS_Textures;
...
extern std::string initialSquareTexturePath, initialRoundTexturePath;
