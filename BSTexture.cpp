...
//		ListaDeCaractere *nodesForXML[1000];
		...
		heroLine->theCharArray2D.push_back("0");
		heroLine->theCharArray2D.push_back(BStoString(HeroInitialX));
		heroLine->theCharArray2D.push_back(BStoString(HeroInitialY));
		heroLine->theCharArray2D.push_back(BStoString(Hero_size));
		heroLine->theCharArray2D.push_back(BStoString(Hero_size));
		...
		for(int i = 0; i < ListOfRoundBodies.size(); i++)
		{
			...
			{
				string2 = BStoString(ListOfRoundBodies[i]->ObstacleCanKillHero);
			}

			if(ListOfRoundBodies[i]->script)
			{
			    string0 = "9";
                string3 = BStoString(ListOfRoundBodies[i]->script->xInitial);
                string4 = BStoString(ListOfRoundBodies[i]->script->yInitial);;
			}
			else
            {
			    string0 = "1";
                string3 = BStoString(ListOfRoundBodies[i]->theBody->GetPosition().x);
                string4 = BStoString(ListOfRoundBodies[i]->theBody->GetPosition().y);
            }

			string5 = BStoString(ListOfRoundBodies[i]->width);
			string6 = BStoString(ListOfRoundBodies[i]->width);
			string7 = salveazaUserData->name;
			string8 = "roundAnimation";
            string9 = BStoString(ListOfRoundBodies[i]->index);

            line->theCharArray2D.push_back(string0); line->theCharArray2D.push_back(string1);
            line->theCharArray2D.push_back(string2); line->theCharArray2D.push_back(string3); line->theCharArray2D.push_back(string4); line->theCharArray2D.push_back(string5);
            line->theCharArray2D.push_back(string6); line->theCharArray2D.push_back(string7); line->theCharArray2D.push_back(string8); line->theCharArray2D.push_back(string9);
		...
		for(int i = 0; i < ListOfSquareBodies.size(); i++)
		{
			...
			{
			    string0 = "8";
                string3 = BStoString(ListOfSquareBodies[i]->script->xInitial);
                string4 = BStoString(ListOfSquareBodies[i]->script->yInitial);
			}
			else
            {
			    string0 = "0";
                string3 = BStoString(ListOfSquareBodies[i]->theBody->GetPosition().x);
                string4 = BStoString(ListOfSquareBodies[i]->theBody->GetPosition().y);
            }

			string1 = ListOfSquareBodies[i]->nameOfTexture;
			string5 = BStoString(ListOfSquareBodies[i]->width);
			string6 = BStoString(ListOfSquareBodies[i]->height);
			string7 = salveazaUserData->name;
			string8 = "textureAnimation";
            string9 = BStoString(ListOfSquareBodies[i]->index);
			...
			{
				string2 = BStoString(ListOfSquareBodies[i]->ObstacleCanKillHero);
			}
            line->theCharArray2D.push_back(string0); line->theCharArray2D.push_back(string1);
            line->theCharArray2D.push_back(string2); line->theCharArray2D.push_back(string3); line->theCharArray2D.push_back(string4); line->theCharArray2D.push_back(string5);
            line->theCharArray2D.push_back(string6); line->theCharArray2D.push_back(string7); line->theCharArray2D.push_back(string8); line->theCharArray2D.push_back(string9);
		...
		for(int i = 0; i < listOfMessages.size(); i++)
		{
			...
			string2 = "0";
			string3 = BStoString(listOfMessages[i]->xCord);
			string4 = BStoString(listOfMessages[i]->yCord);
			string5 = "0";
			string6 = "0";
			string7 = "message";
			string8 = "messageAnimation";
            string9 = BStoString(listOfMessages[i]->index);
		...
		for(int i = 0; i < listOfCoins.size(); i++)
		{
			...
			string2 = "0";
			string3 = BStoString(listOfCoins[i]->xInit);
			string4 = BStoString(listOfCoins[i]->yInit);
			string5 = "1";
			string6 = "1";
			string7 = "coin";
			string8 = BStoString(listOfCoins[i]->available);
            string9 = BStoString(listOfCoins[i]->index);
		...
		for(int i = 0; i < listOfFans.size(); i++)
		{
			...
			string2 = "0";
			string3 = BStoString(listOfFans[i]->xCord);
			string4 = BStoString(listOfFans[i]->yCord);
			string5 = BStoString(listOfFans[i]->width);
			string6 = BStoString(listOfFans[i]->height);
			string7 = BStoString(listOfFans[i]->lenthOfPower) + " " + BStoString(listOfFans[i]->powerX) + " " + BStoString(listOfFans[i]->powerY);
			string8 = "none";
            string9 = BStoString(listOfFans[i]->index);
		...
		for(int i = 0; i < listOfWormHoles.size(); i++)
		{
			...
			string2 = "0";
			string3 = BStoString(listOfWormHoles[i]->xCord);
			string4 = BStoString(listOfWormHoles[i]->yCord);
			string5 = "0";
			string6 = "0";
			string7 = BStoString(listOfWormHoles[i]->indexOfWorm);
			string8 = BStoString(listOfWormHoles[i]->connectionIndex);
            string9 = BStoString(listOfWormHoles[i]->index);
		...
		for(int i = 0; i < ListOfSquareDustBodies.size(); i++)
		{
			ListaDeCaractere *line = new ListaDeCaractere;
			    ...
			    string0 = "10";
                string3 = BStoString(ListOfSquareDustBodies[i]->xInit);
                string4 = BStoString(ListOfSquareDustBodies[i]->yInit);


			string1 = ListOfSquareDustBodies[i]->nameOfTexture;
			string5 = BStoString(ListOfSquareDustBodies[i]->width);
			string6 = BStoString(ListOfSquareDustBodies[i]->height);
			string7 = "object";
			string8 = "dust";
            string9 = BStoString(ListOfSquareDustBodies[i]->index);
